 ...
 * @param indicate: value of 3 (both), 2 (indicate), or 1 (notify). Ignored if hasCCCD is false
 ...
 * @param trapRead if true, a read of the attribute and/or its descriptor will signal the BLE_GATTS_EVT_RW_AUTHORIZE_REQUEST event
