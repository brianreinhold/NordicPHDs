...
// Error codes
#define RACP_OPCODE_NOT_SUPPORTED 2
#define RACP_INVALID_OPERATOR 3
#define RACP_OPERATOR_NOT_SUPPORTED 4
#define RACP_INVALID_OPERAND 5
#define RACP_NO_RECORDS_FOUND 6
#define RACP_ABORT_UNSUCCESSFUL 7
#define RACP_PROCEDURE_NOT_COMPLETED 8
#define RACP_OPERAND_NOT_SUPPORTED 9
#define RACP_SERVER_BUSY 0x0A
...
#define GHS_TIME_FLAG_SUPPORTS_MILLISECONDS 4   // 0000 0100
